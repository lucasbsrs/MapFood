...
public class PedidoStatusResponseDto extends PedidoResponseDto {
	...
	public PedidoStatusResponseDto(String pedidoId, String pedidoStatus, double valorTotal, LocalDateTime atualizadoEm,
			String entregadorId, double distancia, double eta) {
