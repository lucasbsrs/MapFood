...
public interface brainstorm {
	...
	/**
	 ...
	 Quando o pedido for realizado Então deve-se identificar no sistema qual motoboy deve ser selecionado,
	 qual o respectivo trajeto e informações adicionais do trajeto (ex: quilometragem, tempo de entrega…);
	 */
	...
	/**
	 Dado que vários pedidos em localizações próximas foram solicitados em um mesmo estabelecimento e
	 em horários próximos Quando o sistema for selecionar o motoboy e respectiva rota Então o mesmo
	 pode levar em consideração a proximidade desses pedidos para utilizar o mesmo motoboy em tais entregas.
	 */
